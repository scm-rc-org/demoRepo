...
//**  BINDS THE DB2 PLAN AND GENES INPUT FOR SHIPLIST FILE         **           
//**                                                               **           
//*******************************************************************           
...
//SYSUT1 DD *                                                                   
  DSN SYSTEM(DBAG)                                                              
    BIND PACKAGE(DALLASA.PLB&C1ST.C)-                                           
    MEMBER(&C1ELEMENT) -                                                        
    ISOLATION(CS) -                                                             
    RELEASE(C) -                                                                
    SQLERROR(NOPACKAGE)-                                                        
...
/*                                                                              
//********************************************************************          
//*            BATCH SUBMISSION DOES UCD PROCESSING                             
//********************************************************************          
//BATCHSUB EXEC PGM=IEBGENER,ALTID=N                                            
//SYSUT1  DD DATA,DLM=$$                                                        
//RCSYSACC JOB (FB3),'ENDEVOR API',CLASS=B,MSGCLASS=H,                          
//     NOTIFY=&SYSUID,REGION=0M                                                 
//*********************************************************************         
//*  SCANS FOOTPRINT OUTPUT FROM ENDEVOR PROC AND WRITES OUTPUT                 
//*  IN SHIPLIST FORMAT INTO FLAT FILE                                          
//*********************************************************************         
...
/*                                                                              
//*********************************************************************         
//*  SCANS SCL OUTPUT GENERATED INVOKING ENDEVOR IN BATCH MODE                  
//*  IN SHIPLIST FORMAT INTO FLAT FILE                                          
//*********************************************************************         
//*STEP2    EXEC PGM=IKJEFT01,DYNAMNBR=200                                      
//*SYSTSPRT DD  SYSOUT=*                                                        
//*SYSEXEC DD DISP=SHR,DSN=VENDOR.CLIST                                         
//*SYSTSIN DD *                                                                 
//*%UCDSHIP2                                                                    
//*                                                                             
//*********************************************************************         
//*  MERGE ABOVE GENERATED SHIPLIST FILE INTO SINGLE FLATFILE                   
//*********************************************************************         
//*MERGE EXEC PGM=ICEMAN                                                        
//*SORTIN DD DSN=RCSYSAC.UCD.INPUT1,DISP=SHR                                    
//*       DD DSN=RCSYSAC.UCD.INPUT2,DISP=SHR                                    
//*SORTOUT DD DSN=RCSYSAC.UCD.INPUT3,DISP=SHR                                   
//*SYSOUT DD SYSOUT=*                                                           
//*SYSPRINT DD SYSOUT=*                                                         
//*SYSIN DD *                                                                   
//*  OPTION COPY                                                                
...
//OHFS DD PATH='/rcp/sysusr/rcsysac/&C1ELEMENT._&C1AHHMMSS..xml',               
//          PATHDISP=(KEEP,DELETE),                                             
//          PATHOPTS=(OWRONLY,OCREAT,OEXCL),PATHMODE=(SIRUSR,SIWUSR)            
//SYSTSPRT DD SYSOUT=*                                                          
//SYSTSIN DD *                                                                  
OCOPY INDD(INMVS) OUTDD(OHFS) TEXT CONVERT(YES) PATHOPTS(USE)                   
/*                                                                              
//*********************************************************************         
//*  GENERATE SHIPLIST FILE INTO FLATFILE                                       
//*  AND EXECUTING IN FOREGROUND                                                
//*********************************************************************         
//SHIPLIST EXEC PGM=IKJEFT01,DYNAMNBR=30,COND=(4,LT),PARM=                      
...
//SYSTSIN  DD *                                                                 
 ISPSTART CMD(BUZTOOL "createzosversion" "-c" "COURADMN" -                      
  "-v" "&C1ELEMENT._&C1AHHMMSS." -                                              
  "-s" "/rcp/sysusr/rcsysac/&C1ELEMENT._&C1AHHMMSS..xml")                       
/*                                                                              
$$                                                                              
